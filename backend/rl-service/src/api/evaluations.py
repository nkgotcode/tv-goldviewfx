...
def run_evaluation_endpoint(payload: EvaluationRequest) -> EvaluationReport:
    try:
        return run_evaluation(
            ...
            context_intervals=payload.context_intervals,
            ...
            decision_threshold=payload.decision_threshold or 0.35,
            ...
            backtest_mode=payload.backtest_mode.value if hasattr(payload.backtest_mode, "value") else str(payload.backtest_mode),
